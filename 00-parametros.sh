...
OCSVERSION="2.9/OCSNG_UNIX_SERVER-2.9.tar.gz"
OCSTAR="OCSNG_UNIX_SERVER-2.9.tar.gz"
OCSINSTALL="OCSNG_UNIX_SERVER-2.9"
#
...
GLPIFISVERSION="glpi9.5%2B3.0/fusioninventory-9.5+3.0.tar.bz2"
